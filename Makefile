...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	COPYING TODO build-aux/compile build-aux/depcomp \
...
am_blackshades_OBJECTS = src/Button.$(OBJEXT) src/Camera.$(OBJEXT) \
	...
	src/GameLoop.$(OBJEXT) src/GameTick.$(OBJEXT) \
	src/Globals.$(OBJEXT) src/Image.$(OBJEXT) src/Label.$(OBJEXT) \
	src/MacInput.$(OBJEXT) src/Main.$(OBJEXT) src/Maths.$(OBJEXT) \
	src/Models.$(OBJEXT) src/Person.$(OBJEXT) \
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lvorbisfile -lalut -lopenal -lSDL -lGLU -lglut -lGL 
LTLIBOBJS = 
MAKEINFO = makeinfo
...
PACKAGE_STRING = blackshades 0.9
...
src/Button.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/Camera.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/Config.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/Decals.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/Fog.$(OBJEXT): src/$(am__dirstamp) src/$(DEPDIR)/$(am__dirstamp)
src/Font.$(OBJEXT): src/$(am__dirstamp) src/$(DEPDIR)/$(am__dirstamp)
src/Frustum.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/Game.$(OBJEXT): src/$(am__dirstamp) src/$(DEPDIR)/$(am__dirstamp)
src/GameDraw.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/GameInitDispose.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/GameLoop.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/GameTick.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/Globals.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/Image.$(OBJEXT): src/$(am__dirstamp) src/$(DEPDIR)/$(am__dirstamp)
src/Label.$(OBJEXT): src/$(am__dirstamp) src/$(DEPDIR)/$(am__dirstamp)
src/MacInput.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/Main.$(OBJEXT): src/$(am__dirstamp) src/$(DEPDIR)/$(am__dirstamp)
src/Maths.$(OBJEXT): src/$(am__dirstamp) src/$(DEPDIR)/$(am__dirstamp)
src/Models.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/Person.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/Quaternions.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/SDL_funcs.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/Serialize.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/Skeleton.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/Sprites.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
...
include src/$(DEPDIR)/GameDraw.Po
include src/$(DEPDIR)/GameInitDispose.Po
include src/$(DEPDIR)/GameLoop.Po
include src/$(DEPDIR)/GameTick.Po
include src/$(DEPDIR)/Globals.Po
include src/$(DEPDIR)/Image.Po
include src/$(DEPDIR)/Label.Po
include src/$(DEPDIR)/MacInput.Po
include src/$(DEPDIR)/Main.Po
include src/$(DEPDIR)/Maths.Po
include src/$(DEPDIR)/Models.Po
include src/$(DEPDIR)/Person.Po
include src/$(DEPDIR)/Quaternions.Po
include src/$(DEPDIR)/SDL_funcs.Po
include src/$(DEPDIR)/Serialize.Po
include src/$(DEPDIR)/Skeleton.Po
include src/$(DEPDIR)/Sprites.Po
include src/$(DEPDIR)/Support.Po
include src/$(DEPDIR)/TGALoader.Po
include src/$(DEPDIR)/Text.Po
include src/$(DEPDIR)/Weapon.Po
